...
function SummaryForm({formData, handleChange}) {
    ...
    const URL = formData.summaryId === 0 ? "http://localhost:8080/api/summary" : `http://localhost:8080/api/summary/${formData.summaryId}`
    ...
    <form className="bg-white rounded-md">
        ...
        {(formData.summaryId && <button 
            ...
            <button 
                ...
                >
                    {formData.summaryId === 0 ? "add new summary" : "confirm changes"}
                </button>
        </div>
    </form>
    </div>
