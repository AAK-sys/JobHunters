...
const AddInfo = () => {
    ...
    useEffect(() => {
        ...
        educationOptionsArray.push({
            value: defaultEducation.educationId,
            label: "Add new education",
        });
        experienceOptionsArray.push({
            value: defaultExperience.experienceId,
            label: "Add new experience",
        });
        summaryOptionsArray.push({
            value: defaultSummary.summaryId,
        ...
        setUserInfo(user.userInfo || defaultUserInfo);
    }, [user]);
...
<div className="flex flex-wrap justify-between">
    ...
    <div className="w-full md:w-1/2 lg:w-1/4 p-2 md:ml-auto">
        <DynamicForm
            title={"Education"}
